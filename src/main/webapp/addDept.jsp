...
<div class="easyui-panel" id="addUserForm" title="添加部门" style="width:100%;max-width:400px;padding:30px 60px;">
    <div align="center">
        <form id="ad" >
        ...
        <div style="text-align:center;padding:5px 0">
            <button type="button" class="easyui-linkbutton"  data-options="iconCls:'icon-add'" onclick="addDept()"  style="width:80px">添加</button>
    ...
    function addDept() {
        ...
        $.ajax({
            ...
            success:function (result) {
                console.log(result);
                if(result.flag=="200"){
                    $.messager.alert("系统提示", "<font color=green>部门： <span>"+name+"</span>  添加成功</font>");
                    clearForm();
                }else{
                    $.messager.alert("系统提示", "<font color=red>部门添加失败，请重试！</font>");
                }
            }
        });
    }
